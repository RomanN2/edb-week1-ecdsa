import {
  ...
  weiUnits
} from "./chunk-3W2TFNQC.js";
import {
  SHA2,
  equalBytes,
  secp256k1,
  sha256
} from "./chunk-PD7D3AWW.js";
import {
  wrapConstructor
} from "./chunk-OCBIIXXR.js";
...
async function getWebSocketRpcClient(url, options = {}) {
  ...
  return getSocketRpcClient({
    async getSocket({ onError, onOpen, onResponse }) {
      const WebSocket = await import("./native-NADKD6HH.js").then((module) => module.WebSocket);
...
async function recoverPublicKey({ hash, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-JZYM7JFX.js");
  const signature_ = (() => {
